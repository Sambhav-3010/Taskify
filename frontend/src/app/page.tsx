  ...
  return (
    <>
      {loading ? (
        ...
        <div className="bg-background pt-[80px] flex flex-col">
          <main className="container mx-auto px-4 flex-1 flex flex-col justify-center items-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16 w-full">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    See who’s online, track progress together, and collaborate seamlessly with your team in real-time.
                  </CardDescription>
                </CardHeader>
              </Card>
            ...
            {/* CTA Section */}
            {!user && (
              <div className="text-center bg-card border border-border rounded-lg p-8 w-full max-w-xl">
